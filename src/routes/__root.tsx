...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/klockogram-logo.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/klockogram-logo.jpg" },
    ...
    links: [
      ...
      { rel: "icon", href: "/klockogram-logo.jpg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/klockogram-logo.jpg" },
